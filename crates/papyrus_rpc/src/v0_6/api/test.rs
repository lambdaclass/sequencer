...
use super::api_impl::{BLOCK_HASH_TABLE_ADDRESS, JsonRpcServerImpl};
...
fn generate_client_transaction_client_receipt_and_rpc_receipt(
    ...
    *client_transaction.transaction_hash_mut() = pending_transaction_hash;
    (client_transaction, client_transaction_receipt, PendingTransactionReceipt {
...
async fn get_deprecated_class_state_mutability() {
    ...
    storage_writer
        ...
        .unwrap()
        .append_classes(header.block_number, &[], &[
