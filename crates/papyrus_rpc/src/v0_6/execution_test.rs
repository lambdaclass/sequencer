...
async fn trace_block_transactions_regular_and_pending() {
    ...
    writer
        ...
        .unwrap()
        .append_body(BlockNumber(2), BlockBody {
        ...
        .unwrap()
        .append_state_diff(BlockNumber(2), ThinStateDiff {
    ...
    *pending_data.write().await = PendingData {
    ...
    let res = module
        .call::<_, Vec<TransactionTraceWithHash>>("starknet_V0_6_traceBlockTransactions", [
            BlockId::Tag(Tag::Pending),
        ])
        .await
        .unwrap();
